...
![dnsnode](https://img.madawei.net/dnsnode.jpg)
然后在blog目录里面的source目录下新建一个CNAME文件，文件内容就是你自己的域名。
![cname](https://img.madawei.net/cname.jpg)
...
![Mou](https://img.madawei.net/mou.png)
...
![微博图床](https://img.madawei.net/weibotuchuang.png)
